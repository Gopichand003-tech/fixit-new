        ...
        >
          {filtered.map((w) => (
            <div
              key={w.id}
              className="
                group relative w-[300px] h-[420px]
...
/>
              ...
              {/* Content */}
<div className="relative z-20 h-full flex flex-col justify-end p-6 text-white space-y-4">
...
">
  ...
  {w.location}
   ...
   <div className="flex justify-center gap-2 bg-white/10 backdrop-blur rounded-xl py-2 text-sm">
  ...
  {formatPhone(w.phone)}
                ...
                <button
                  ...
                  className="mt-2 py-2 rounded-full bg-indigo-600 hover:bg-indigo-500 font-semibold"
                >
                  Book a Slot
                </button>
              </div>
